...
export default function Header() {
  ...
  return (
    <div className="h-32 md:h-32">
      <header className="fixed w-full z-100 bg-neutral-100 md:bg-opacity-90 transition duration-300 ease-in-out ">
        <div className="max-w-6xl mx-auto px-5 sm:px-6">
          <div className="flex items-center justify-between h-16 md:h-20">
            <div className="shrink-0 mr-4 flex-1">
              <Link href={"https://keploy.io/"}>
                <img
                  src="/test-generator/images/sidebyside-transparent.svg"
                  alt=""
            ...
            <div className="flex lg:hidden">
              ...
              >
                ...
                <MenuBtn />
                {/* <img src="/test-generator/images/Menu.svg" className="w-6 h-6"></img> */}
              </button>
              <div>
                {toggleMenu ? (
